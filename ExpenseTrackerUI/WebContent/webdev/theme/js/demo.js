...
demo = {
	...
	initDashboardPageCharts : function() {
		...
		var emailsSubscriptionChart = Chartist.Bar('#emailsSubscriptionChart',
	...
	initGoogleMaps : function() {
		...
		var mapOptions = {
			zoom : 13,
			center : myLatlng,
			scrollwheel : false, // we disable de scroll over the map, it is a really annoing
			// when you scroll through page
			styles : [ {
				"featureType" : "water",
				"stylers" : [ {
					"saturation" : 43
